    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">🏪 Minimarket Log In</h1>
          <p className="text-gray-500 mt-2">Silakan masuk ke akun admin Anda</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {processing ? 'MENGOTENTIKASI...' : 'MASUK SEKARANG'}
          </button>

          {/* Bagian info kredensial yang ditambahkan */}
          <div className="text-center text-xs text-gray-400 mt-4 bg-gray-50 p-2 rounded">
            <p>Username: <strong>admin@minimarket.com</strong></p>
